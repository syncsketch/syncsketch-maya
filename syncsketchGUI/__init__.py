...
if updateNeeded:
	...
	def getLatestInstallerPyFileFromRepo():
		...
		try:
			import syncsketchGUI.installScripts.installGui
			installerPath = syncsketchGUI.installScripts.installGui.__file__[:-1]

		except ImportError:
			print "installerGui not loaded, please use mel installer"
			return
