...
record_icon = _get_qicon('record_icon_100.png')
play_icon   = _get_qicon('play_icon_100.png')
upload_icon = _get_qicon('upload_icon_100.png')
preset_icon = _get_qicon('manage_presets_icon_100.png')
target_icon = _get_qicon('target_icon_100.png')
download_icon = _get_qicon('download_icon_100.png')
playground_icon = _get_qicon('icon_playground_small.png')
...
refresh_icon = _get_qicon('refresh_icon.png')
