...
1. Click this File Link ![maya2017](https://img.shields.io/badge/Maya2017-tested-brightgreen.svg) > [installCrossPlatform.mel](https://github.com/syncsketch/syncsketch-maya/releases/download/release/installCrossPlatformGUI.mel#install) < to download the installation mel file.
