...
__Test in Dev__: `pip install --ignore-installed --verbose --user --target=/Users/USERNAME/Library/Preferences/Autodesk/maya/2018/scripts/  https://github.com/syncsketch/python-api/archive/v1.0.5.zip
`
